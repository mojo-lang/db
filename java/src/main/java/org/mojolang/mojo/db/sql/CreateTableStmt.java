...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 90: {
            ...
            tableName_ = input.readMessage(org.mojolang.mojo.db.sql.TableName.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 114: {
            org.mojolang.mojo.db.sql.TableDefinition.Builder subBuilder = null;
            if (definitionCase_ == 14) {
              subBuilder = ((org.mojolang.mojo.db.sql.TableDefinition) definition_).toBuilder();
            }
            definition_ =
                input.readMessage(org.mojolang.mojo.db.sql.TableDefinition.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((org.mojolang.mojo.db.sql.TableDefinition) definition_);
          ...
          case 122: {
            org.mojolang.mojo.db.sql.AsSubqueryClause.Builder subBuilder = null;
            if (definitionCase_ == 15) {
              subBuilder = ((org.mojolang.mojo.db.sql.AsSubqueryClause) definition_).toBuilder();
            }
            definition_ =
                input.readMessage(org.mojolang.mojo.db.sql.AsSubqueryClause.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((org.mojolang.mojo.db.sql.AsSubqueryClause) definition_);
              definition_ = subBuilder.buildPartial();
            }
            definitionCase_ = 15;
            break;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      org.mojolang.mojo.db.sql.CreateTableStmt parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (org.mojolang.mojo.db.sql.CreateTableStmt) e.getUnfinishedMessage();
    ...
    public Builder mergeTableName(org.mojolang.mojo.db.sql.TableName value) {
      if (tableNameBuilder_ == null) {
        if (tableName_ != null) {
          tableName_ =
            org.mojolang.mojo.db.sql.TableName.newBuilder(tableName_).mergeFrom(value).buildPartial();
        } else {
          tableName_ = value;
        }
        onChanged();
