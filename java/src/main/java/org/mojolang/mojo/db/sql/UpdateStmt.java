...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 98: {
            org.mojolang.mojo.db.sql.QualifiedTableName.Builder subBuilder = null;
            if (tableName_ != null) {
              subBuilder = tableName_.toBuilder();
            }
            tableName_ = input.readMessage(org.mojolang.mojo.db.sql.QualifiedTableName.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 106: {
            org.mojolang.mojo.db.sql.SetClause.Builder subBuilder = null;
            if (set_ != null) {
              subBuilder = set_.toBuilder();
            }
            set_ = input.readMessage(org.mojolang.mojo.db.sql.SetClause.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 130: {
            org.mojolang.mojo.db.sql.ReturningClause.Builder subBuilder = null;
            if (returning_ != null) {
              subBuilder = returning_.toBuilder();
            }
            returning_ = input.readMessage(org.mojolang.mojo.db.sql.ReturningClause.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  @java.lang.Override public org.mojolang.mojo.db.sql.UpdateStmt.Type getType() {
    ...
    org.mojolang.mojo.db.sql.UpdateStmt.Type result = org.mojolang.mojo.db.sql.UpdateStmt.Type.valueOf(type_);
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      org.mojolang.mojo.db.sql.UpdateStmt parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (org.mojolang.mojo.db.sql.UpdateStmt) e.getUnfinishedMessage();
    ...
    public Builder mergeTableName(org.mojolang.mojo.db.sql.QualifiedTableName value) {
      if (tableNameBuilder_ == null) {
        if (tableName_ != null) {
          tableName_ =
            org.mojolang.mojo.db.sql.QualifiedTableName.newBuilder(tableName_).mergeFrom(value).buildPartial();
        } else {
          tableName_ = value;
        }
        onChanged();
    ...
    public Builder mergeSet(org.mojolang.mojo.db.sql.SetClause value) {
      if (setBuilder_ == null) {
        if (set_ != null) {
          set_ =
            org.mojolang.mojo.db.sql.SetClause.newBuilder(set_).mergeFrom(value).buildPartial();
        } else {
          set_ = value;
        }
        onChanged();
    ...
    public Builder mergeReturning(org.mojolang.mojo.db.sql.ReturningClause value) {
      if (returningBuilder_ == null) {
        if (returning_ != null) {
          returning_ =
            org.mojolang.mojo.db.sql.ReturningClause.newBuilder(returning_).mergeFrom(value).buildPartial();
        } else {
          returning_ = value;
        }
        onChanged();
