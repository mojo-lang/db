...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 106: {
            ...
            from_ = input.readMessage(org.mojolang.mojo.db.sql.Expression.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 114: {
            ...
            to_ = input.readMessage(org.mojolang.mojo.db.sql.Expression.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      org.mojolang.mojo.db.sql.BetweenExpr parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (org.mojolang.mojo.db.sql.BetweenExpr) e.getUnfinishedMessage();
    ...
    public Builder mergeFrom(org.mojolang.mojo.db.sql.Expression value) {
      if (fromBuilder_ == null) {
        if (from_ != null) {
          from_ =
            org.mojolang.mojo.db.sql.Expression.newBuilder(from_).mergeFrom(value).buildPartial();
        } else {
          from_ = value;
        }
        onChanged();
    ...
    public Builder mergeTo(org.mojolang.mojo.db.sql.Expression value) {
      if (toBuilder_ == null) {
        if (to_ != null) {
          to_ =
            org.mojolang.mojo.db.sql.Expression.newBuilder(to_).mergeFrom(value).buildPartial();
        } else {
          to_ = value;
        }
        onChanged();
