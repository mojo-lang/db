...
public interface OrderByClauseOrBuilder extends
   ...
   */
  java.util.List<org.mojo-lang.mojo.db.sql.Ordering> 
      getOrderingsList();
  /**
   * <code>repeated .mojo.db.sql.Ordering orderings = 10;</code>
   */
  org.mojo-lang.mojo.db.sql.Ordering getOrderings(int index);
  /**
   * <code>repeated .mojo.db.sql.Ordering orderings = 10;</code>
   */
   ...
   * <code>repeated .mojo.db.sql.Ordering orderings = 10;</code>
   */
  java.util.List<? extends org.mojo-lang.mojo.db.sql.OrderingOrBuilder> 
      getOrderingsOrBuilderList();
  /**
   * <code>repeated .mojo.db.sql.Ordering orderings = 10;</code>
   */
  org.mojo-lang.mojo.db.sql.OrderingOrBuilder getOrderingsOrBuilder(
      int index);
}
